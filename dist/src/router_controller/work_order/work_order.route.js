...
const work_order_get_all_controller_1 = require("./controller/work_order.get.all.controller");
...
work_order.get("/work_order", auth_1.default, work_order_get_all_controller_1.work_orderGETAll);
